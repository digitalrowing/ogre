var manual =
[
    [ "Introduction", "_introduction.html", null ],
    [ "The Core Objects", "_the-_core-_objects.html", [
      ...
      [ "Overlays", "_the-_core-_objects.html#Overlays", null ]
    ] ],
    ...
    [ "High-level Programs", "_high-level-_programs.html", [
      ...
      [ "DirectX9 HLSL", "_high-level-_programs.html#HLSL", null ],
      [ "OpenGL GLSL", "_high-level-_programs.html#GLSL", [
        [ "GLSL Texture Samplers", "_high-level-_programs.html#GLSL-Texture-Samplers", null ],
        [ "Matrix parameters", "_high-level-_programs.html#Matrix-parameters", null ],
        [ "Accessing OpenGL states in GLSL", "_high-level-_programs.html#Accessing-OpenGL-states-in-GLSL", null ],
        ...
        [ "GLSL Geometry shader specification", "_high-level-_programs.html#GLSL-Geometry-shader-specification", null ]
      ] ],
      ...
      [ "Using GPU Programs in a Pass", "_high-level-_programs.html#Using-Vertex_002fGeometry_002fFragment-Programs-in-a-Pass", [
        [ "Parameter specification", "_high-level-_programs.html#Program-Parameter-Specification", null ]
      ] ],
      ...
      [ "Vertex texture fetching in vertex programs", "_high-level-_programs.html#Vertex-texture-fetching-in-vertex-programs", null ],
      [ "Vertex Texture Fetch", "_high-level-_programs.html#Vertex-Texture-Fetch", null ]
    ] ],
    [ "Runtime Shader Generation", "_runtime-_shader-_generation.html", "_runtime-_shader-_generation" ],
    [ "Mesh Tools", "_mesh-_tools.html", [
      [ "Exporters", "_mesh-_tools.html#Exporters", null ],
    ...
    [ "Hardware Buffers", "_hardware-_buffers.html", [
      [ "Buffer Usage", "_hardware-_buffers.html#Buffer-Usage", [
        ...
        [ "Locking buffers", "_hardware-_buffers.html#Locking-buffers", null ],
        [ "Practical Buffer Tips", "_hardware-_buffers.html#Practical-Buffer-Tips", null ]
      ] ],
      [ "Hardware Vertex Buffers", "_hardware-_buffers.html#Hardware-Vertex-Buffers", [
        ...
        [ "Important Considerations", "_hardware-_buffers.html#Important-Considerations", null ],
      ...
      [ "Hardware Pixel Buffers", "_hardware-_buffers.html#Hardware-Pixel-Buffers", [
        ...
        [ "Updating Pixel Buffers", "_hardware-_buffers.html#Updating-Pixel-Buffers", null ],
        ...
        [ "Texture Types", "_hardware-_buffers.html#Texture-Types", null ],
        [ "Cube map textures", "_hardware-_buffers.html#Cube-map-textures", null ],
        [ "Pixel Formats", "_hardware-_buffers.html#Pixel-Formats", null ],
        [ "Colour channels", "_hardware-_buffers.html#Colour-channels", null ],
        [ "List of pixel formats", "_hardware-_buffers.html#Complete-list-of-pixel-formats", null ],
    ...
    [ "Shadows", "_shadows.html", [
      ...
      [ "Stencil Shadows", "_shadows.html#Stencil-Shadows", null ],
      [ "Texture-based Shadows", "_shadows.html#Texture_002dbased-Shadows", null ],
      [ "Configuring Texture Shadows", "_shadows.html#Configuring-Texture-Shadows", null ],
      ...
      [ "Modulative Shadows", "_shadows.html#Modulative-Shadows", null ],
    ...
    [ "Animation", "_animation.html", [
      ...
      [ "Vertex Animation", "_animation.html#Vertex-Animation", null ],
      [ "SceneNode Animation", "_animation.html#SceneNode-Animation", null ],
      [ "Numeric Value Animation", "_animation.html#Numeric-Value-Animation", null ]
    ] ]
];